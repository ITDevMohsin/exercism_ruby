...
# Introduction
# Like everything in Ruby, a String is an object. Strings are made up of an arbitrary sequence of bytes (normally characters)
# and are initialized and manipulated like any other object. In fact, one of the most useful things about Ruby is the numerous methods
# that can be called on strings (and other objects) to save you a lot of time writing code. In this exercise we are going to explore and
# play with some of those helper methods.
...
# The most common literals are single and double quotes ('...' and "..."). Single quotes do not allow interpolation, whereas double quotes do.
...
# Note: There's no absolute rule saying you have to use non-interpolated strings if your string does not contain interpolation.

# -----------------------------------------

# Interacting with strings
# It is helpful to think of Strings in Ruby in a similar way to how you think of Arrays.They have a size and
# their characters are indexed (with 0 as the first index) :
...
# The semantic values of strings can also be manipulated. It's worth exploring the Ruby docs to learn about all the methods,
# but here are a few commonly used examples:
...
# In all of the examples above, a new String is returned. However, many methods have equivalents which end in ! which actually modify the string itself.
